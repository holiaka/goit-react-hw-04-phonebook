...
export const App = () => {
  ...
  const handleSubmit = (evt) => {
    ...
    setContacts([...contacts, { id: nanoid(), name: evt.name, number: evt.number }]);
  };
  ...
  return (
      ...
      >
        <div>
          ...
          <ContactList contacts={visibleContacts} deleteContact={deleteContact}></ContactList>
        </div>
      </div>
    );
